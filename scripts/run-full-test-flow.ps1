...
- 若 `9-system-test-report` 为未执行或需更新，使用 `system-test-report` skill 基于本轮归档和 stage-status 生成或更新系统测试报告。



- 若 `10-knowledge-base` 为未执行或需更新，使用 `knowledge-base` skill 在系统测试报告后沉淀知识资产。
...
$allStages = @(
    ...
    @{ Name = "9-system-test-report"; Type = "check"; Action = { Invoke-StageCheckResult -Name "9-system-test-report" -StageId "9-system-test-report" -Mode "full" } },
    
    @{ Name = "10-knowledge-base"; Type = "check"; Action = { Invoke-StageCheckResult -Name "10-knowledge-base" -StageId "10-knowledge-base" -Mode "full" } }
...
$reportStages = @("9-system-test-report", "10-knowledge-base")
...
$pendingReportStages = @("9-system-test-report", "10-knowledge-base")
