# 阶段 06：API 缺陷清单（IPD 管理系统，批次 20260812-134401）

## 1. 当前阶段
API 自动化缺陷登记（接口契约/文档一致性 & 接口契约/实现一致性 两类分开）

## 2. 输入文件
- `projects/ipd/docs/test-runs/20260812-134401/raw/api-results/pytest-full-api-stdout.txt`（缺陷 stdout 证据源）
- `projects/ipd/docs/cases/API测试用例-评审版.md`
- 需求分析阶段 §KAN §M3 §WF 对应功能/命名/参数名的"产品/研发/测试口径预期"

## 3. 产出文件
- `projects/ipd/docs/test-runs/20260812-134401/defects/API缺陷清单.md`（本文件）
